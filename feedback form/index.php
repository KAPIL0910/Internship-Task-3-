...
<body class="agileits_w3layouts">
    <h1 class="agile_head text-center">Parent's Feedback Form</h1>
    <div class="w3layouts_main wrap">
	  <h3>Please help us to serve you better by giving us a couple of minutes. </h3>
	    <form action="http://localhost/result-manage/index.php" method="post" class="agile_form">
		  <h2>How satisfied are you with your Child Result?</h2>
			...
			<center><input type="submit" value="submit Feedback" class="http://localhost/result-manage/index.php" /></center>
	  </form>
	</div>
	<div class="agileits_copyright text-center">
			<p>© Copyright All Rights Reserved By : Kapil Sharma </p>
	</div>
</body>
</html>
